...
export default function Header({loading, setLoading, user}) {
        ...
        <div>
            <AppBar className={classes.appBar} position="fixed">
                ...
                <Toolbar
                    ...
                    variant="dense">
                    <img height="100%" width="150vw" src="https://www.logo.wine/a/logo/Instagram/Instagram-Wordmark-Black-Logo.wine.svg" alt="instagram-logo"/>
